...
# Hola! 👋 Soy Joel 💻
Desarrollador Full-Stack con fuerte enfoque en backend y sistemas en tiempo real.
He trabajado en proyectos en producción que combinan software, hardware e integraciones complejas, participando desde la arquitectura hasta la entrega final.

Tengo experiencia con Laravel, Node/Express, Vue y Python, desarrollando APIs, sistemas en tiempo real (WebSockets), integraciones de pago (Stripe) y plataformas conectadas a dispositivos físicos.

En los últimos años he asumido responsabilidades técnicas y de coordinación en equipos pequeños, gestionando varios proyectos simultáneamente y tratando directamente con clientes.

Actualmente busco un entorno técnico saludable, con foco en calidad, buenas prácticas y equilibrio entre vida personal y trabajo.
## 🛠 Mi Stack 
